      ...
      {isOpen && (
        ...
        >
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col items-center rounded border p-2">
              <FileInputIcon className="mb-2 h-6 w-6" />
              Input
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <MenuIcon className="mb-2 h-6 w-6" />
              Dropdown
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <KeyIcon className="mb-2 h-6 w-6" />
              Button
            </div>
            <div className="flex flex-col items-center rounded border p-2">
            ...
            <div className="flex flex-col items-center rounded border bg-blue-100 p-2">
              <CheckIcon className="mb-2 h-6 w-6 text-blue-600" />
              Checkbox
            </div>
            <div className="flex flex-col items-center rounded border p-2">
            ...
            <div className="flex flex-col items-center rounded border p-2">
              <TabletsIcon className="mb-2 h-6 w-6" />
              Tabs
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <ContainerIcon className="mb-2 h-6 w-6" />
              Container
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <FormInputIcon className="mb-2 h-6 w-6" />
              Form
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <SlidersIcon className="mb-2 h-6 w-6" />
              Slideout
            </div>
            <div className="flex flex-col items-center rounded border p-2">
            ...
            <div className="flex flex-col items-center rounded border p-2">
              <LayoutGridIcon className="mb-2 h-6 w-6" />
              Grid
            </div>
            <div className="flex flex-col items-center rounded border p-2">
              <MapIcon className="mb-2 h-6 w-6" />
              Map
            </div> */}
          </div>
        </motion.div>
